...
export default function AdminPortal() {
  ...
  const renderLeagueManagement = () => (
    <div className="admin-section admin-section--league" style={{ flex: 1 }}>
      ...
      {league?.pool_type === 'pickem' && <section style={{ marginBottom: '3rem' }}>
        <h4 style={{ color: '#2d3748', marginBottom: '1rem' }}>Weekly Bar Pick Sheet</h4>
        <div style={{ backgroundColor: 'white', padding: '1.5rem', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
          <p style={{ color: '#4a5568', margin: '0 0 1rem' }}>Print a blank sheet containing this pool&apos;s in-scope matchups, checkboxes, patron name line, and Monday-night tiebreaker when applicable.</p>
