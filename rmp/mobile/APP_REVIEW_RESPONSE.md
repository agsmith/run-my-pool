...
Thank you for the clarification. We revised the iOS app so it is a free,
participant-only companion for invited pool members.

The iOS app does not sell anything, include purchase links or calls to action,
...
Commissioner tools are a separate website service and are not available or
unlocked inside the iOS app. The app's participant features are available to
...
The password is stored in the App Review Information sign-in fields.

Thank you.

## App Review Information notes

Use the supplied ordinary-member account to review the complete native
participant experience. It is active, verified, and has no administrator or
commissioner role.
