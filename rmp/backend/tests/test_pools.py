...
class TestPoolEndpoints:
    ...
    def test_pool_validation_empty_name(self, authenticated_client):
        """Test pool creation with empty name"""
        client, user_data = authenticated_client
    ...
    def test_pool_creation_audit_logging(self, mock_audit, authenticated_client, test_pool_data):
...
class TestPoolAdminOperations:
    ...
    def test_check_admin_access_non_owner(self, client, test_user_data):
        ...
        # This test would require creating a pool with one user
        # and checking access with another user
